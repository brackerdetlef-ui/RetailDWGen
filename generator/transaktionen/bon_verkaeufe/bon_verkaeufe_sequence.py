...
============================================================
Projekt : RetailDWGen
Datei   : bon_verkaeufe_sequence.py
Version : 2.0.1
...
"""
Verwaltung der fortlaufenden Bon-Sequence-IDs.
...
class BonVerkaeufeSequence:
    """
    Verwaltet fortlaufende Bon-Sequence-IDs je Filiale.
    """

    def __init__(
        self,
        storage_file: str = "konfiguration/bon_verkaeufe_sequences.json"
    ):
    ...
    def initialize_store(
        ...
        Beispiel:
        Filiale 003 startet mit 97000001.
        """
    ...
    def get_next_id(
        ...
        """
        Liefert die naechste Bon-Sequence-ID.
        """
    ...
    def get_current_id(
        ...
        """
        Liefert die zuletzt vergebene Bon-Sequence-ID.
        """
