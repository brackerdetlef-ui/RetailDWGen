...
============================================================
Projekt : RetailDWGen
Datei   : kunden_retouren_sequence.py
Version : 2.0.1
...
"""
Verwaltung der fortlaufenden Kundenretouren-IDs.
...
class KundenRetourenSequence:
    ...
    def __init__(
        self,
        storage_file: str = "konfiguration/kunden_retouren_sequences.json"
    ):
    ...
    def initialize_store(
        ...
        Beispiel:
        Filiale 003 startet mit 75000001.
        """
    ...
    def get_next_id(
        ...
        """
        Liefert die naechste Kundenretouren-ID.
        """
    ...
    def get_current_id(
        ...
        """
        Liefert die zuletzt vergebene Kundenretouren-ID.
        """
