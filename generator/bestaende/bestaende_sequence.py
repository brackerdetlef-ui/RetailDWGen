...
"""
Verwaltung der fortlaufenden Bestands-IDs.
...
class BestaendeSequence:
    """
    Verwaltet fortlaufende Bestands-IDs je Lager.
    """

    def __init__(
        self,
        storage_file: str = "konfiguration/bestaende_sequences.json"
    ):
    ...
    def initialize_store(
        ...
        Beispiel:
        Lager 210 startet mit 85000001.
        """
    ...
    def get_next_id(
        ...
        """
        Liefert die naechste Bestands-ID.
        """
    ...
    def get_current_id(
        ...
        """
        Liefert die zuletzt vergebene Bestands-ID.
        """
